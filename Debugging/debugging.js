...
function countToFive() {
  ...
  for (let i = 0; i < len; i++) {
    //start the count at 0 and used < symbol for the condition
...
/**
 * @param {Use Caution When Reinitializing Variables Inside a Loop}
...
/**
 * @param Prevent Infinite Loops with a Valid Terminal Condition
...
// }
function myFunc() {
  for (let i = 1; i != 4; i += 2) { // Solution change the Not (!) operator to less than equal to operator (<=)
    console.log("Still going!");
  }
}